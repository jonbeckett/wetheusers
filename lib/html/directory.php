...
function render_user($user_row){
	...
	$html .= "<div class=\"avatar\"><a href=\"/".$user_row["Username"]."\" title=\"".$user_row["Username"]."\"><img src=\"/".$avatar_image."\" width=\"64\" height=\"64\" alt=\"".$user_row["Username"]."\" border=\"0\" /></a></div>\n"
		."<div class=\"username\">\n"
...
function render_user_directory($tag_name="",$page=1){
	...
	$html .= "<div class=\"bg_menu_wrapper\">\n"
		...
		."<li class=\"selected\"><a href=\"/explore/directory\" title=\"Directory\">Directory</a></li>\n"
	...
	if ($tag_name == ""){
		...
		while ($tags_row =@ $tags_result_b->fetch_assoc()){
			...
			$html .= "<div class='tag' style='font-size:".$size."em !important;'><a title='".addslashes($tags_row["TagName"])."' href='/explore/directory/".htmlspecialchars($tags_row["TagName"])."'>".str_replace(" ","&nbsp;",$tags_row["TagName"])."</a><br /><small>".$tags_row["TagCount"]." users</small></div>\n";
		}
		...
		$html .= render_pagination("explore/directory".$tag_name,$page,$count,20);
			
	} else {

		$html .= "<div id=\"header\">\n"
			."<h1>Directory : &#8216;<span>".$tag_name."</span>&#8217;</h1>\n"
